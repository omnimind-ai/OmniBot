...
for (const character of (marker === '/compact' ? marker : `Reply ${marker}`)) {
...
assert.equal(field(input(ready), 'text'), marker === '/compact' ? marker : `Reply ${marker}`, 'Draft mismatch; not sending');
