...
class NativeHomeNavigationTest {
    ...
    @Test fun settingsRestoresAcrossSavedStateAndReturnsToHome() {
        ...
        restoration.setContent {
            NativeHomeApp(state.value, actions(setService = { state.value = state.value.copy(localServiceEnabled = it) }),
                about = { _, _, _ -> }, storage = {}, requestLogs = {}, runtimeLogs = {}, workspaceMemory = { _, _ -> },
                permissions = {}, appearance = { _, _ -> }, background = { _, _ -> }, pet = {}, homePreferences = {}, miscellaneous = { _, _ -> })
        }
        capture("home-light")
    ...
    @Test fun drawerOpensTheSelectedConversationWithoutCreatingAnotherIdentity() {
        ...
        compose.setContent {
            ...
            ), actions(open = { opened.add(it) }), about = { _, _, _ -> }, storage = {}, requestLogs = {}, runtimeLogs = {}, workspaceMemory = { _, _ -> },
                permissions = {}, appearance = { _, _ -> }, background = { _, _ -> }, pet = {}, homePreferences = {},
                miscellaneous = { _, _ -> })
        }
        compose.onNodeWithContentDescription(label(R.string.omni_open_drawer)).performClick()
    ...
    @Test fun settingsOpensNativeMiscAndReturnsToSettings() {
        compose.setContent {
            NativeHomeApp(NativeHomeState(loading = false), actions(), about = { _, _, _ -> }, storage = {}, requestLogs = {}, runtimeLogs = {}, workspaceMemory = { _, _ -> }, permissions = {},
