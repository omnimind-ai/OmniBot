...
class PlatformModelApiClient(
    ...
    private data class CatalogDefaultsResponse(
        ...
        @SerializedName("speech_to_text") val speechToText: String? = null,
    ...
    private data class CatalogCapabilitiesResponse(
        ...
        @SerializedName("stt") val stt: List<String>? = null,
        @SerializedName("speech_to_text") val speechToText: List<String>? = null,
    ...
    private fun OfficialCatalogResponse?.toDomain(
        ...
        return PlatformModelCatalog(
            ...
            defaults = PlatformModelDefaults(
                ...
                // Legacy `voice` described text-to-speech. Transcription is a
                // separate capability and must be explicitly declared.
                stt = firstId(defaults?.stt, defaults?.speechToText),
            ...
            capabilities = PlatformModelCapabilities(
                ...
                stt = firstIds(capabilities?.stt, capabilities?.speechToText),
