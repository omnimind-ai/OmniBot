...
data class OfficialModelSelection(
    ...
    val sttModels: List<PlatformModel> = emptyList(),
    ...
    val defaultSttModel: PlatformModel? = null,
...
object OmniOfficialProvider {
    ...
    fun selectModels(
        ...
        val sttModels = if (catalog.hasOfficialCatalog) {
            declared(catalog.capabilities.stt)
        } else {
            emptyList()
        }
        ...
        return OfficialModelSelection(
            ...
            defaultSttModel = declaredDefault(catalog.defaults.stt, sttModels),
